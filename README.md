...
- **パフォーマンス**: WordPress Transient APIを使用した効率的キャッシュ
...
- **キャッシュ期間**: 3時間、6時間、12時間、1日、1週間、永久から選択
- **手動クリア**: 設定画面から即座にキャッシュクリア可能
- **自動更新**: 指定期間経過後、自動的に最新情報で更新
...
- **日時形式**: ISO 8601 UTC（例: 2025-09-08T11:01:20Z）
