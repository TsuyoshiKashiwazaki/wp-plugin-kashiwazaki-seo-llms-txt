                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    <label>
                                        <input type="checkbox" name="yaml_settings[retry-policy][retry]" value="1" <?php checked( $yaml_settings['retry-policy']['retry'] ); ?> />
                                        リトライを許可する
                                    </label><br>
                                    ...
                                    <label for="retry_after">リトライ待機時間:</label> <input type="number" id="retry_after" name="yaml_settings[retry-policy][retry-after-seconds]" value="<?php echo esc_attr( $yaml_settings['retry-policy']['retry-after-seconds'] ); ?>" min="1" step="1" class="small-text" /> 秒<br>
